...
# Dividing the dataset into training and testing data. As it is weekly, so the size of testing data will be 168
from sklearn.model_selection import train_test_split
#X_train, X_test, y_train, y_test = train_test_split(X, y, test_size = 0.05, random_state = 0)

X_train =  x_scaled[:10800, 0:-1]
y_train =  y_scaled[:10800, -1]
X_test  = x_scaled[10800:, 0:-1]
y_test =  y_scaled[10800:, -1]
...
#saving the model
import pickle
pickle.dump(regressor, open("rf_weekly.pkl", 'wb'))
