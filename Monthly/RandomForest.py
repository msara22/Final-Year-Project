...
X_train =  x_scaled[:10250, 0:-1]
y_train =  y_scaled[:10250, -1]
X_test  = x_scaled[10250:, 0:-1]
y_test =  y_scaled[10250:, -1]
...
pickle.dump(regressor, open('model_random_forest.pkl', 'wb'))
